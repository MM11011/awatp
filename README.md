...
<pre><code>``` awatp/ ├── core/ │ ├── scanner.py │ ├── fingerprints.py │ └── payloads/ │ ├── sql.py │ ├── xss.py │ └── ssti.py ├── reports/ ├── utils/ │ └── parser.py ├── main.py ├── requirements.txt ├── README.md └── venv/ ``` </code></pre>
